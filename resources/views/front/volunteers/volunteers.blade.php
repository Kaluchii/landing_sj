...
@section('content')
    ...
    <section class="info-page">
        <h1 class="info-page__block-title">ВОЛОНТЕРАМ</h1>
        <div class="info-page__wrap-1010">
            ...
            <div class="info-page__sub-navigation sub-navigation">
                <ul class="sub-navigation__list">
                    @foreach($inf_pages as $item)
                        <li class="sub-navigation__item"><span class="sub-navigation__link-wrap"><a href="/for-volunteers/{{$item->slug_field}}" class="sub-navigation__link yellow-link">{{$item->page_title_field}}</a></span></li>
                    @endforeach
                </ul>
            </div>
        </div>
