...
@section('content')
    ...
    @include('back.content-top', ['title' => 'Информационные страницы для волонтеров'])
        ...
        <div class="col-xs-12">
            <div class="box table-widget">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        Список информационных страницы для волонтеров
                    </h3>
                ...
                <div class="box-body">
                    <table class="table table-bordered table-hover dataTable table-widget-selector" role="grid"
                        ...
                        @foreach($block->vol_info_page_group as $item)
                            @include('back.groups.vol_info_page.vol_info_page_row',['item' => $item])
                        @endforeach
