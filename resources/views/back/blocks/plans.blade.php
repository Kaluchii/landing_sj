...
@section('content')
    ...
    @include('back.content-top', ['title' => 'Планы'])
    ...
    <div class="box box box-info">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label>Изображение (570 x 650 px)</label>
                <div class="dropzone">
                                ...
                                <div class="file-preview-frame">
                                    ...
                                    <div class="file-thumbnail-footer">
                                        ...
                                        <div class="file-actions">
                                            <input type="text" class="form-control alt-text" data-block="plans" data-type="images" data-id="0" data-name="alt">
    ...
    <div class="box box-info group-item-widget"
        ...
        <div class="box-header with-border">
            <h3 class="box-title"> Список планов </h3>
            <button type="submit" data-parent="0" class="btn btn-primary pull-right add-flat-item">Добавить</button>
        </div>
        <div class="box-body">

            <div class="groupflat-widget group-item-wrap">
                @foreach($block->plans_list_group as $item)
                    @include('back.groups.plans_list.plans_list_box', ['item' => $item])
                @endforeach
            </div>
        </div>
    </div>
