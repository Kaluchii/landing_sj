...
@section('content')
    ...
    @include('back.content-top', ['title' => 'Свяжитесь с нами'])
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control string"
                       ...
                       data-type="string"
                       data-block="contact_us"
                       data-id="0">
            </div>

            <div class="form-group">
                <label>Фотография (280 x 340 px)</label>
                <div class="dropzone">
                                ...
                                <div class="file-preview-frame">
                                    ...
                                    <div class="file-thumbnail-footer">
                                        ...
                                        <div class="file-actions">
                                            <input type="text" class="form-control alt-text" data-block="contact_us" data-type="images" data-id="0" data-name="alt">
