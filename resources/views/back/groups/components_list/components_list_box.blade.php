<div class="box">
    <div class="box-header with-border">
        ...
        <button type="submit" class="btn btn-primary pull-right remove-flat-item" data-id="{{$item->id_field}}"
                data-block="components_list">Удалить</button>
    </div>
    <div class="box-body">
                            ...
                            <div class="file-preview-frame">
                                ...
                                <div class="file-thumbnail-footer">
                                    ...
                                    <div class="file-actions">
                                        <input type="text" class="form-control alt-text" data-block="components_list" data-type="images" data-id="{{$item->id_field}}" data-name="alt" value="{{$item->img_field->alt}}">
