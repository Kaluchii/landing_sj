<tr role="row" class="odd" data-id="{{$item->id_field}}">
    ...
    {{-- Название  --}}
    <td class="sorting_1">
        <a href="for-volunteers/{{$item->id_field}}" class="">{{$item->page_title_field}}</a>
    </td>
    ...
    {{-- Удаления  --}}
    <td>
        <button type="button" class="btn btn-block btn-primary group-remove-item" data-id="{{$item->id_field}}" data-block="vol_info_page">Удалить</button>
    </td>
</tr>