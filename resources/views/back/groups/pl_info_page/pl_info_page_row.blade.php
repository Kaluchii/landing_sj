<tr role="row" class="odd" data-id="{{$item->id_field}}">
    ...
    {{-- Название  --}}
    <td class="sorting_1">
        <a href="for-players/{{$item->id_field}}" class="">{{$item->page_title_field}}</a>
    </td>
    ...
    {{-- Удаления  --}}
    <td>
        <button type="button" class="btn btn-block btn-primary group-remove-item" data-id="{{$item->id_field}}" data-block="pl_info_page">Удалить</button>
    </td>
</tr>